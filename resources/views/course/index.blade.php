...
@section('content')
    <div class="container ">
        <div class="p-6 flex flex-row">
            ...
            <div class="ml-6 w-30 pr-10 border-r border-gray-200">
                <div class="max-w-md text-right leading-loose tracking-tight top-0">
                    <p class="font-bold my-12">Previous Posts</p>

                    <ul class="flex flex-wrap justify-between flex-col">
                        <li>
                            <h5 class="nav">Previous blog posts links</h5>
                            <ul>
            ...
            <div class="ml-20">
                <div class="max-w-screen-lg leading-loose tracking-tight ml-4">
                    <h1 class="font-bold mt-12 mb-8 text-center">Post Title</h1>
