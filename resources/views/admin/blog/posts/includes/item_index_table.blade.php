<table class="w-full text-sm text-left text-white">
    ...
    <tr>
        <th scope="col" class="px-6 py-3">
            {{__('admin/blog/posts/index.table_id')}}
        </th>
        <th scope="col" class="px-6 py-3">
            {{__('admin/blog/posts/index.table_title')}}
        </th>
        <th scope="col" class="px-6 py-3">
            {{__('admin/blog/posts/index.table_category_title')}}
        </th>
        <th scope="col" class="px-6 py-3">
            {{__('admin/blog/posts/index.table_course_title')}}
        </th>
        <th scope="col" class="px-6 py-3">
            {{__('admin/blog/posts/index.table_description')}}
        </th>
        <th scope="col" class="px-6 py-3 text-center">
            {{__('admin/blog/posts/index.table_actions')}}
        </th>
    </tr>
    </thead>
    <tbody>
    @foreach($posts as $post)
        <tr class="border-b border-bl-200 bg-gray-500">
            ...
            <td class="px-6 py-4 flex flex-column justify-around">
                <a href="{{route('admin.blog.posts.show', ['post'=>$post->id])}}">
                ...
                <form method="POST" action="{{route('admin.blog.posts.destroy', ['post'=>$post->id])}}">
                    @method("DELETE")
                    @csrf
                    <button>
