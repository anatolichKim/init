    ...
    <ul class="space-y-2 mt-10">
        ...
        <li>
            ...
            <ul id="dropdown-users" class="hidden py-2 space-y-2">
                <li>
                    <a href="{{route('admin.user.data.index')}}"
        ...
        <li>
            <form method="POST" action="{{route('auth.logout')}}">
                @csrf
                <button class="flex items-center p-2 text-base font-normal rounded-lg hover:text-blue-500 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                    type="submit">
                    <svg
                        class="flex-shrink-0 w-6 h-6 transition duration-75 dark:text-gray-400 dark:group-hover:text-white"
                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
