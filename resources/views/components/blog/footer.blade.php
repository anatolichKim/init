 <div class="text-white w-full flex flex-col justify-between">
     <div class="flex flex-row px-20 w-full">
         <div class="w-[30%]">
            ...
            <div class="flex flex-row mt-5">
                <a href="#" class="text-gray-300 hover:text-white dark:hover:text-white">
         ...
         <div class="ml-10 grid grid-cols-4 gap-5">
             ...
             <div>
                 ...
                 <ul class="text-gray-300">
                     <li class="mb-4">
                         <a href="#" class="hover:text-white">Discord Server</a>
                     </li>
                     <li class="mb-4">
             ...
             <div>
                 ...
                 <ul class="text-gray-300">
                     <li class="mb-4">
                         <a href="#" class="hover:text-white">iOS</a>
                     </li>
                     <li class="mb-4">
                         <a href="#" class="hover:text-white">Android</a>
                     </li>
                     <li class="mb-4">
                         <a href="#" class="hover:text-white">Windows</a>
                     </li>
                     <li class="mb-4">
                         <a href="#" class="hover:text-white">MacOS</a>
                     </li>
                 </ul>
             </div>
         </div>
     ...
     <div class="ml-10 p-4 sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-300 sm:text-center dark:text-gray-300">
            © 2022 <a href="https://flowbite.com" class=" hover:text-white">Flowbite™</a>. All Rights Reserved.
        </span>
