     ...
     <div class="grid grid-cols-5 gap-8 place-content-between px-20">
         <div>
             ...
             <ul class="text-gray-300">
                 ...
                 <li class="mb-4">
                     <a href="#" class="hover:text-white">Brand Center</a>
                 </li>
                 <li class="mb-4">
     ...
     <div class="flex flex-row justify-between px-20 w-full">
         <div class="w-[30%]">
             <div>
                 ...
                 <p class="mt-2">{{__('blog/components/footer.description_extra')}}</p>
             </div>

            <div class="flex flex-row mt-5">
                <a href="#" class="text-gray-300 hover:text-blue-500 dark:hover:text-blue-500">
...
>>>>>>> 3363acb117000b26d3ddb23f2877557c4875fa46
         </div>
         <div class="ml-10 grid grid-cols-4 gap-5">
             <div>
                 <h2 class="mb-6 text-sm font-semibold text-white uppercase">Company</h2>
                 <ul class="text-gray-300">
                     <li class="mb-4">
                     ...
                     <li class="mb-4">
                         <a href="#" class="hover:text-blue-500">Brand Center</a>
                     </li>
                     <li class="mb-4">
             ...
             <div>
                 ...
                 <ul class="text-gray-300">
                     <li class="mb-4">
                         <a href="#" class="hover:text-blue-500">Discord Server</a>
                     </li>
                     <li class="mb-4">
             ...
             <div>
                 ...
                 <ul class="text-gray-300">
                     ...
                     <li class="mb-4">
                         <a href="#" class="hover:text-blue-500">Licensing</a>
                     </li>
                     <li class="mb-4">
             ...
             <div>
                 ...
                 <ul class="text-gray-300">
                     <li class="mb-4">
                         <a href="#" class="hover:text-blue-500">iOS</a>
                     </li>
                     <li class="mb-4">
                         <a href="#" class="hover:text-blue-500">Android</a>
                     </li>
                     <li class="mb-4">
                         <a href="#" class="hover:text-blue-500">Windows</a>
                     </li>
                     <li class="mb-4">
                         <a href="#" class="hover:text-blue-500">MacOS</a>
                     </li>
                 </ul>
             </div>
         </div>
